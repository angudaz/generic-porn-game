...
label options1:
    ...
    # Ill add images later -josh
        ...
        "What happened?":
            jump options1_what_happened

        "Who am I?":
            jump options1_who_am_i

        "Who are you to me?" if memory:
            jump options1_who_are_you

        "No other questions":
            jump options1_no_question


label options1_where:
    if known_name:
        jf "Where am I?"
